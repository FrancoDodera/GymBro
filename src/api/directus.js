        ...
        try {
            const response = await client.request(
                readItems('planes_ia', {
                    ...
                    fields: [
                        '*',
                        'ejercicios_plan_ia.id',
                        'ejercicios_plan_ia.ejercicio_id.*',
                        'ejercicios_plan_ia.ejercicio_id.imagen_referencia.*',
                        'ejercicios_plan_ia.ejercicio_id.video_referencia.*',
                        'ejercicios_plan_ia.ejercicio_id.imagen_url_1',
                        'ejercicios_plan_ia.ejercicio_id.imagen_url_2',
                        'ejercicios_plan_ia.dia',
                        'ejercicios_plan_ia.orden',
                        'ejercicios_plan_ia.series',
                        'ejercicios_plan_ia.repeticiones',
                        'ejercicios_plan_ia.duracion_minutos',
                        'ejercicios_plan_ia.notas'
                    ],
                    sort: ['-fecha_generacion'],
                    limit: 1
                })
